...
<body>
        ...
        <div class="me-page-title">
            ...
            <div class="row" style="margin-bottom:0px!important;">
                <div class="col s8">
                    <h1>Contents</h1>
                    <!--Page description-->
                    <p>List of page contents.</p>               
                </div>
                <div class="col s4">
                    <a href="/admin/website/contents-add" class="btn-floating waves-effect waves-light default float-right"><i class="material-icons">add</i></a>
                </div>
            </div>
        </div>
        <!--Page body content-->
        <div class="me-page-body">
            <div class="row">
                <div class="col s12 m-t-10">
                    <table id="website-content-items" class="bordered"></table>
                </div>
            </div>
    ...
    <!-- Page Modules -->
    <script type="module" src="/admin-portal/modules/website-contents.js"></script>
