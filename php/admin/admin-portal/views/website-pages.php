...
<head>
    ...
    <!--Page title-->
    <title>Pages | APSU USA Portal</title>
    <!-- CSS  -->
...
<body>
    ...
    <main>
        <div class="me-page-title">
            ...
            <div class="row" style="margin-bottom:0px!important;">
                ...
                <div class="col s4">
                    <button id="add-new-page" class="btn-floating waves-effect waves-light default float-right"><i class="material-icons">add</i></button>
                </div>
            </div>
        </div>
        ...
        <div class="me-page-body">
            <div class="row">
                <div class="col s12 m-t-10">
                    <table id="website-page-items" class="bordered"></table>
                </div>
            </div>
    ...
    <!-- Page Modules -->
    <script type="module" src="/admin-portal/modules/website-pages.js"></script>
